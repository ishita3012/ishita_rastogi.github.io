...
Handwritten Text Recognition (HTR) system is the Neural Network (NN) model that recognizes the text contained in the images of segmented words as shown in the illustration below.
